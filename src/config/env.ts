...
const envSchema = z.object({
  ...
  WHATSAPP_PROVIDER: z.string().optional().default('ultramsg'),
  ULTRAMSG_INSTANCE_ID: z.string().optional().default('instance189337'),
  ULTRAMSG_TOKEN: z.string().optional().default('sd62425yieoj0nch'),
